...
_TABLE: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "help_me": "/aoe4 me                  查看绑定信息（加 -gid 显示最近GID；加 -image 强制图片输出）",
        ...
        "help_radar": "/aoe4 radar [ID] [-n N]   上一局评分雷达图（需 Playwright）",
    ...
    "en": {
        ...
        "help_me": "/aoe4 me                   View bound info (add -gid for recent GIDs; add -image for image output)",
        ...
        "help_radar": "/aoe4 radar [ID] [-n N]    Radar chart of last game (requires Playwright)",
